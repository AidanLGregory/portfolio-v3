...
function ProjectItem({ imgUrl, title, stack, linkUrl, codeUrl, description }) {
    ...
    // Conditional logic for setting target attribute of <a> tags
    // If either linkUrl or codeUrl are present, open link in new tab, otherwise don't so the javascript:void(0) isn't shown in new tab
                ...
                <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md w-full">
                    ...
                    <div class="p-5">
                        ...
                        <div className="flex flex-wrap items-center justify-evenly">
                            <p class="my-3 mb-5 font-normal text-gray-700">{description}</p>
                            <a href={linkUrl === "/" ? 'javascript:void(0);' : linkUrl} className={linkUrl === "/" ? 'cursor-not-allowed' : 'cursor-pointer'} target={linkTarget}>
                            ...
                            <a href={codeUrl === "/" ? 'javascript:void(0);' : codeUrl} className={codeUrl === "/" ? 'cursor-not-allowed' : 'cursor-pointer'} target={codeTarget}>
